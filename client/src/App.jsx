      ...
      <div>
        <Routes>
          ...
          <Route
            exact
            path="/Sports"
            element={<ProtectedRoute Component={Sports} />}
          ></Route>
          ...
          <Route
            exact
            path="/sportdetails"
            element={<ProtectedRoute Component={SportDetails} />}
          ></Route>
          ...
          <Route
            exact
            path="/regedit"
            element={<ProtectedRoute Component={RegEdit} />}
          ></Route>
        ...
        <Route exact path ='/addcomp' element={<RPR Component={AddComp} />}>
          ...
          <Route
            exact
            path="/user/:id"
            element={<RPR Component={SingleUser} />}
          ></Route>

          <Route
            exact
            path="/challan/:id"
            element={<RPR Component={ChallanDetails} />}
          ></Route>

          <Route exact path="/PleaseWait" element={<PleaseWait />}></Route>

          <Route exact path="/ForgetPass" element={<ForgetPass />}></Route>

          <Route
            exact
            path="/ForgetPass/:token"
            element={<ResetPass />}
          ></Route>

          <Route exact path="/MailSent" element={<MailSent />}></Route>
        </Routes>
      </div>
    </Router>
  );
